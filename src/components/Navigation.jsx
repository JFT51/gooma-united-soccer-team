        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center relative">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <img src={logo} alt="Gooma United Logo" className="absolute left-0 bottom-0 transform translate-y-1/2 h-36 w-36" />
              <span className="text-2xl font-bold pl-40">Gooma United</span>
            </Link>
          </div>
