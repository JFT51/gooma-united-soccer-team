    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <a href="http://wwww.monsieurpneus.be" target="_blank"><img src="https://jft51.github.io/gooma-united-soccer-team/src/assets/mp.png" alt="Sponsor Logo" className="mx-auto h-58" /></a>
